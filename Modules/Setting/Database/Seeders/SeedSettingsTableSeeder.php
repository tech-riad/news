...
class SeedSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['title' => 'application_name', 'value' => 'NEWS', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'copyright_text', 'value' => 'Copyright © 2020 News and Magazine - All Rights Reserved.', 'lang' => 'en']);
