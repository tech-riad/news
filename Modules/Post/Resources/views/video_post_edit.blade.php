                                ...
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        @if($post->post_type=='video')
                                            @if(isFileExist(@$post->videoThumbnail, $result =  @$post->videoThumbnail->thumbnail))
                                                <img src=" {{basePath($post->videoThumbnail)}}/{{ $result }}"
                                                     id="video_thumb_preview"  width="200" height="200"alt="{!! $post->title !!}" class="img-responsive img-thumbnail image_preview">
                                            @else
