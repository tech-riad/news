                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div id="panel_quiz_result_{{ $quiz_result->id }}"
                                                ...
                                                <div class="panel panel-default mt-2 bg-white">
                                                    <div class="panel-heading" role="tab"
                                                        ...
                                                        <h4 class="panel-title d-flex">
                                                            <a role="button" data-toggle="collapse"
                                                               ...
                                                               href="#collapse_result_{{ $quiz_result->id }}"
                                                               aria-expanded="false"
                                                               aria-controls="collapse_result_{{ $quiz_result->id }}">
                                                                #<span
                                                                    id="result_number_{{ $quiz_result->id }}">{{ $key+1 }}</span>
                                                                <span
                                                                    id="result_{{ $quiz_result->id }}">{{ $quiz_result->result_title }}</span>
                                                            </a>
                                                    ...
                                                    <div id="collapse_result_{{ $quiz_result->id }}"
                                                         ...
                                                         role="tabpanel"
                                                         aria-labelledby="heading_{{ $quiz_result->id }}"
                                                         style="">
                                                        <div class="panel-body bg-white">
                                                            ...
                                                            <div class="col-12 col-lg-12">
                                                                <div class="col-sm-12 pr-0">
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="result_input"><b>{{ __('result') }}
                                                                                *</b></label>
                                                                        <input hidden name="result[]"
                                                                               value="{{ $quiz_result->id }}">
                                                                        <input type="text" id="result_input" required
                                                                               ...
                                                                               data-is-update="1"
                                                                               value="{{ $quiz_result->result_title }}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-lg-12">
                                                                <div class="row">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="form-group text-center">
                                                                                    @if(isFileExist($quiz_result->image, $result = @$quiz_result->image->thumbnail))
                                                                                        <img
                                                                                            src=" {{basePath($quiz_result->image)}}/{{ $result }} "
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                name="result_content_{{ $quiz_result->id }}"
                                    ...
                                    <div class="row m-3">
                                        <div class="col-sm-12 text-center">
                                            <button type="button" id="btn_add_quiz_result_to_db"
